...
Follow `context/git-workflow.md`: default to `develop`, use `feat/<slug>`, never delete `main`/`develop`, delete merged feature branches only after the user confirms the PR merged on GitHub.
