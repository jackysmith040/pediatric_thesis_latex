...
- [x] **1.6 Refactor Temporal Filtering (Bayesian $\to$ Weighted Temporal Smoothing)**: Replace "recursive Bayesian updating" with *weighted temporal smoothing* ($\bar{P}_k(t) = 0.70 \cdot P_{\text{hist}} + 0.30 \cdot P_{\text{roll}}$). Update equations and Research Question 4 accordingly. *(Points 18, 19)*
