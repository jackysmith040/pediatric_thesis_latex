...
\begin{enumerate}[(i)]
    ...
    \item Formulate and empirically evaluate a cephalocaudal allometric classification metric ($R_{\text{ceph}} = L_{\text{torso}}/L_{\text{leg}}$) from 17-point pose estimation to differentiate observed children from adults.
