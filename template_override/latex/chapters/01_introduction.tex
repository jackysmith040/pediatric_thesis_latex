...
\begin{enumerate}[(i)]
    \item How does rank-1 separable convolution filtering compare with 2D spatial convolution in arithmetic complexity and computational workload on edge hardware?
    ...
    \item To what extent does the skeletal cephalocaudal ratio ($R_{\text{ceph}} = L_{\text{torso}} / L_{\text{leg}}$) provide a measurable separation margin between pre-pubescent children and adults under the evaluated camera geometries and viewing conditions?
