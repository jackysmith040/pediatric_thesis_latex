...
\begin{enumerate}[(i)]
    ...
    \item Build a high-resolution inference pipeline combining Contrast Limited Adaptive Histogram Equalization (CLAHE) and Slicing Aided Hyper Inference (SAHI) to detect small and occluded persons.
    ...
    \item Develop a dual-horizon temporal consensus filter that stabilizes demographic classifications across tracklet frames and prevents identity flips.
...
\begin{enumerate}[(i)]
    ...
    \item How effectively does dual-horizon temporal consensus smoothing reduce single-frame posture noise and maintain tracklet demographic identity during temporary occlusions?
