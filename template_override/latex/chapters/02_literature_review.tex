...
\begin{enumerate}[(i)]
    ...
    \item \textbf{Dynamic Inter-Object Occlusion:} Walking or seated occupants block each other. In Ghana, mothers carry infants wrapped against their bodies. This causes up to $80\%$ visual occlusion of the child \cite{addotey2023, ouyang2015}.
\end{enumerate}
