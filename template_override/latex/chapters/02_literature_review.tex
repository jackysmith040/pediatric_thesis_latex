...
\begin{enumerate}[(i)]
    \item \textbf{The Semantic-Biological Disconnect:} Existing deep learning detectors optimize bounding boxes using geometric criteria (IoU, aspect ratio) alone. Among the studies reviewed in this thesis, we did not identify works that integrate allometric cephalocaudal growth laws ($R_{\text{ceph}} = L_{\text{torso}}/L_{\text{leg}}$) directly as a verification rule for pediatric person counting.
