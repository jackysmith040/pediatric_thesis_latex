...
$\tau_{\text{ceph}}$ & $0.80$ & Cephalocaudal ratio threshold ($L_{\text{torso}} / L_{\text{leg}}$) & Derived from allometric human growth literature \cite{bogin1999, camacho2022}, separating children from adults. \\
...
Deploying computer vision in healthcare environments requires strict data governance and privacy safeguards \cite{milkaite2019, alvarez2024}. This section details administrative approvals, non-interventional waivers, patient privacy safeguards, and the zero-retention edge deployment model.
