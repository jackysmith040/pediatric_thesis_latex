...
For the secondary crop classification engine, we extracted 4,200 person crops from candidate detections. This balanced set contains 2,100 pediatric crops and 2,100 adult crops. We partitioned the dataset into 70\% for training (2,940 crops), 15\% for validation (630 crops), and 15\% for testing (630 crops).
...
The research protocol received administrative permission and operational approval from the management of Komfo Anokye Teaching Hospital (KATH) and the KNUST University Hospital in Kumasi, Ghana.
...
To eliminate these privacy risks by design, the framework implements a zero-retention edge processing model:
\begin{enumerate}[(i)]
