...
\end{itemize}
Because crop splitting occurred randomly across sequential video frames, these validation metrics are likely optimistic. Shared clothing and lighting attributes across training and testing partitions can inflate scores compared to sequence-independent evaluation. The crop model executes in $1.8\text{--}2.4\text{ ms}$ per crop on host CPUs under ONNX Runtime. It outputs a raw demographic child probability:
\begin{equation}
