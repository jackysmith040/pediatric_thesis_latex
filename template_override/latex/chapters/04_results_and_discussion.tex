...
The test results show that, in the evaluated clips, adding cephalocaudal allometric constraints and temporal consensus filtering improves demographic counting accuracy compared with the baseline detector.
