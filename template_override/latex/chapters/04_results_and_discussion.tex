...
\begin{enumerate}[(i)]
    ...
    \item \textbf{Operational Deployment Reality:} Unconstrained clinic deployments feature dense crowds, changing light, and long occlusions. These conditions will cause tracking errors. Practitioners must view these results as evidence that the design functions on tested clips. It is not an assertion that the system will achieve $100\%$ accuracy in all real-world deployments.
\end{enumerate}
